...
| Skills | `skills/` | Specialist code reviewers, plugin customization routing, version reporting, active PR automation, telemetry guidance, and Agents background setup |
